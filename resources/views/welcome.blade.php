    ...
    <div class="container">
        ...
        <div class="navbar-left">
            ...
            <a class="navbar-brand" href="../index.html">
                ...
                <img class="logo-light" src="{{asset('theme/assets/img/logo-dark.png/assets/img/logo-light.png')}}" alt="logo">
            </a>
        </div>
                    ...
                    <div class="row gap-y">
                        ...
                        <div class="col-md-6">
                            <div class="card border hover-shadow-6 mb-6 d-block">
                                <a href="#"><img class="card-img-top" src="{{asset('theme/assets/img/thumb/1.jpg')}}" alt="Card image cap"></a>
                        ...
                        <div class="col-md-6">
                            <div class="card border hover-shadow-6 mb-6 d-block">
                                <a href="#"><img class="card-img-top" src="{{asset('theme/assets/img/thumb/2.jpg')}}" alt="Card image cap"></a>
                                <div class="p-6 text-center">
                        ...
                        <div class="col-md-6">
                            <div class="card border hover-shadow-6 mb-6 d-block">
                                <a href="#"><img class="card-img-top" src="{{asset('theme/assets/img/thumb/4.jpg')}}" alt="Card image cap"></a>
                                <div class="p-6 text-center">
                        ...
                        <div class="col-md-6">
                            <div class="card border hover-shadow-6 mb-6 d-block">
                                <a href="#"><img class="card-img-top" src="{{asset('theme/assets/img/thumb/5.jpg')}}" alt="Card image cap"></a>
                                <div class="p-6 text-center">
                        ...
                        <div class="col-md-6">
                            <div class="card border hover-shadow-6 mb-6 d-block">
                                <a href="#"><img class="card-img-top" src="{{asset('theme/assets/img/thumb/6.jpg')}}" alt="Card image cap"></a>
                                <div class="p-6 text-center">
                ...
                <div class="col-md-4 col-xl-3">
                    <div class="sidebar px-4 py-md-0">
                        ...
                        <a class="media text-default align-items-center mb-5" href="blog-single.html">
                            <img class="rounded w-65px mr-4" src="{{asset('theme/assets/img/thumb/4.jpg')}}">
                            <p class="media-body small-2 lh-4 mb-0">Thank to Maryam for joining our team</p>
                        </a>

                        <a class="media text-default align-items-center mb-5" href="blog-single.html">
                            <img class="rounded w-65px mr-4" src="{{asset('theme/assets/img/thumb/3.jpg')}}">
                            <p class="media-body small-2 lh-4 mb-0">Best practices for minimalist design</p>
                        </a>

                        <a class="media text-default align-items-center mb-5" href="blog-single.html">
                            <img class="rounded w-65px mr-4" src="{{asset('theme/assets/img/thumb/5.jpg')}}">
                            <p class="media-body small-2 lh-4 mb-0">New published books for product designers</p>
                        </a>

                        <a class="media text-default align-items-center mb-5" href="blog-single.html">
                            <img class="rounded w-65px mr-4" src="{{asset('theme/assets/img/thumb/2.jpg')}}">
    ...
    <div class="container">
        <div class="row gap-y align-items-center">
            ...
            <div class="col-6 col-lg-3">
                <a href="../index.html"><img src="{{asset('theme/assets/img/logo-dark.png')}}" alt="logo"></a>
            </div>
